    ...
    <div className="min-h-screen container relative">
      ...
      <div className="flex-col justify-start items-start gap-5 inline-flex mt-2">
        <p className="self-stretch text-center text-white text-sm font-medium leading-tight">
          Make sure to write it down or copy it as shown here. You have to
          verify this later.
        </p>
      </div>
      ...
      <div className="mt-5">
        <div className="grid grid-cols-2 gap-4">
          {seedPhrase?.split(" ").map((word, index) => (
            <div
              key={index}
              className="bg-primary/20 rounded-full px-1 justify-start items-center inline-flex"
            >
              <div className="justify-center items-center flex w-8">
                <div className="text-center text-white text-lg font-normal select-none">
                  {index + 1}
                </div>
              </div>
      ...
      <span
        ...
        className="block text-center mt-4 underline cursor-pointer"
      >
