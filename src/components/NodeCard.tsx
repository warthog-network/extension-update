...
const NodeCard = ({
  ...
  return (
    <>
      <div
        className={`px-2 flex justify-between items-center w-full mt-6 relative border-l-2 cursor-pointer border-[curentColor] hover:bg-orange-400 ${selectedNodeIndex === id ? "bg-[currentColor]" : ""}`}
        onClick={() => setPrimaryNode(id)}
      >
